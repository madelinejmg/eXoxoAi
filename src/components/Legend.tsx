const CATEGORIES = [
  ...
  { name: 'Ice Giant', color: '#4FC3F7' },
  { name: 'Rocky', color: '#D32F2F' },
  { name: 'Super Earth', color: '#7CB342' },
];

export function Legend() {
  return (
    <div className="fixed bottom-6 right-6 bg-slate-900/80 backdrop-blur-sm rounded-lg p-4 border border-white/10 shadow-lg">
